...
public class guardar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        software.setNombre(request.getParameter("nombre"));
        software.setDescripcion(request.getParameter("descripcion").replaceAll("\n", " ").replaceAll("\r", " ").replaceAll("\t", " "));
        software.setLicencia(request.getParameter("licencia"));
        software.setUrl(request.getParameter("url"));
        software.setVersion(request.getParameter("version"));
        PrintWriter out = response.getWriter();
        try {
            String msg;
            if (software.getId() == 0) {//Insertar
                software.insertar();
                msg = "Software insertado con éxito";
            } else { //Actualizar
                software.actualizar();
                msg = "Software actualizado con éxito";
            }
